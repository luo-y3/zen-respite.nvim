...
return function(opts)
  ...
  -- Line Numbers and Sign Column (Low Contrast)
  set(0, "SignColumn",    { fg = c.base0, bg = bg_main })
  set(0, "LineNr",        { fg = c.base0, bg = bg_main })
  set(0, "CursorLineNr",  { fg = c.yellow, bg = bg_alt, bold = true })
  
  -- etc
  set(0, "VertSplit",     { fg = c.border, bg = bg_main })
  set(0, "Folded",        { bg = bg_main })
  ...
  set(0, "TelescopeBorder",       { bg = bg_main })
