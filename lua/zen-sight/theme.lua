-- zen-sight.nvim/lua/zen-sight/theme.lua
...
function M.setup()
  ...
  theme.editor = {
    ...
    BufferLineBackground = { fg = colors.fg_comment, bg = colors.bg_highlight },
    BufferLineBufferSelected = { fg = colors.fg, bg = colors.bg_visual },
    BufferLineBufferVisible = { fg = colors.fg, bg = colors.bg_visual },
    ...
    BufferLineHint = { fg = colors.blue, bg = colors.bg_highlight },
    BufferLineHintSelected = { fg = colors.blue, bg = colors.bg_visual },
    BufferLineHintdisSelected = { fg = colors.blue, bg = colors.bg_highlight },
    BufferLineHintVisible = { fg = colors.blue, bg = colors.bg_visual },
    BufferLineHintDiagnostic = { fg = colors.blue, bg = colors.bg_highlight },
    BufferLineHintDiagnosticSelected = { fg = colors.blue, bg = colors.bg_visual },
    BufferLineHintDiagnosticVisible = { fg = colors.blue, bg = colors.bg_visual },

    BufferLineError = { fg = colors.red, bg = colors.bg_highlight },
    BufferLineErrorSelected = { fg = colors.red, bg = colors.bg_visual },
    BufferLineErrorVisible = { fg = colors.red, bg = colors.bg_visual },
    BufferLineErrorDiagnostic = { fg = colors.orange, bg = colors.bg_highlight },
    BufferLineErrorDiagnosticSelected = { fg = colors.orange, bg = colors.bg_visual },
    BufferLineErrorDiagnosticVisible = { fg = colors.orange, bg = colors.bg_visual },

    BufferLineWarning = { fg = colors.yellow, bg = colors.bg_highlight },
    BufferLineWarningDiagnosticSelected = { fg = colors.yellow, bg = colors.bg_visual },
    BufferLineWarningDiagnosticVisible = { fg = colors.yellow, bg = colors.bg_visual },
    BufferLineWarningDiagnostic = { fg = colors.yellow, bg = colors.bg_highlight },
    BufferLineWarningSelected = { fg = colors.yellow, bg = colors.bg_visual },
    BufferLineWarningVisible = { fg = colors.yellow, bg = colors.bg_visual },

    BufferLineIndicatorVisible = { bg = colors.bg_visual },
    BufferLineIndicatorSelected = { bg = colors.border },

    BufferLineSeparator = { bg = colors.bg_highlight },
    BufferLineSeparatorSelected = { bg = colors.bg_visual },
    BufferLineSeparatorVisible = { bg = colors.bg_visual },
  ...
  theme.lsp = {
    ...
    LspReferenceText = { bg = colors.lsp_bg },
    LspReferenceRead = { bg = colors.lsp_bg },
    LspReferenceWrite = { bg = colors.lsp_bg },
  }
