...
function M.setup()
  ...
  theme.editor = {
    ...
    NormalFloat = { fg = colors.fg, bg = transparent and "NONE" or colors.bg_highlight },
    ...
    BufferLineHintVisible = { fg = colors.blue, bg = colors.bg_visual, style = "italic" },
    BufferLineHintDiagnostic = { fg = colors.blue, bg = colors.bg_highlight, style = "italic" },
    BufferLineHintDiagnosticSelected = { fg = colors.blue, bg = colors.bg_visual, style = "italic,bold" },
    BufferLineHintDiagnosticVisible = { fg = colors.blue, bg = colors.bg_visual, style = "italic" },
    ...
    BufferLineWarningDiagnosticVisible = { fg = colors.yellow, bg = colors.bg_visual, style = "italic" },
    BufferLineWarningDiagnostic = { fg = colors.yellow, bg = colors.bg_highlight, style = "italic" },
    BufferLineWarningSelected = { fg = colors.yellow, bg = colors.bg_visual, style = "italic,bold" },
    BufferLineWarningVisible = { fg = colors.yellow, bg = colors.bg_visual, style = "italic" },

    BufferLineIndicatorVisible = { bg = colors.bg_visual, style = "italic" },
    BufferLineIndicatorSelected = { bg = colors.border, style = "italic,bold" },

    BufferLineSeparator = { bg = colors.bg_highlight, style = "italic" },
    BufferLineSeparatorSelected = { bg = colors.bg_visual, style = "italic,bold" },
    BufferLineSeparatorVisible = { bg = colors.bg_visual, style = "italic" },
    BufferLineModified = { bg = colors.bg_highlight, style = "italic" },
    BufferLineModifiedSelected = { bg = colors.bg_visual, style = "italic,bold" },
    BufferLineModifiedVisible = { bg = colors.bg_visual, style = "italic" },
